...
/// **Either** - Type-safe error handling monad
///
...
///
/// `Either` makes errors explicit in the type system by making them part of 
...
/// the right one free. So, the [map] and [flatMap] methods are right-biased.
@immutable
@sealed
